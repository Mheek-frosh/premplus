...
const ServiceSection = () => {
    return (
        <section id="service-area" className="py-24 bg-white relative overflow-hidden">
                    ...
                    {services.map((service, index) => (
                        ...
                        >
                            <div className="relative h-56 overflow-hidden">
                                ...
                                <div className="absolute bottom-4 left-4 p-3 bg-white/90 backdrop-blur rounded-2xl shadow-lg">
                                    {service.icon}
                                </div>
                            </div>
                            <div className="p-8">
